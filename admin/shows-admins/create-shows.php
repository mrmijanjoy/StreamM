...
if(isset($_POST['submit'])){
  if(empty($_POST['title']) OR empty($_POST['description']) OR empty($_POST['type']) OR empty($_POST['studios']) OR empty($_POST['date_aired']) OR empty($_POST['status'])OR empty($_POST['genre'])OR empty($_POST['duration'])OR empty($_POST['quality'])OR empty($_POST['num_available']) OR empty($_POST['num_total'])) {
    ...
    $insert = $conn->prepare("INSERT INTO shows(title,description,type,studios,date_aired,status,genre,quality,num_available,num_total,image) VALUES(:title,  :description, :type, :studios,  :date_aired,  :status,  :genre,:quality,  :num_available, :num_total, :image)");
